...
static const ENTRY plotopts[] = {
  ...
  {"plotcomplex",	parseopts_set_mode_complex},
  {"plotmulti",		parseopts_set_mode_multi},
  ...
  {"plotdefault",	parseopts_set_default},
  {"plotgrid",		parseopts_set_grid},
  {"plotlogx",		parseopts_set_logx},
